# 💬 Ubiquitous Messaging Platform - API de Mensageria em Tempo Real

> Plataforma de mensageria escalável construída com arquitetura orientada a eventos, gRPC para APIs de alto desempenho, Kafka para processamento assíncrono e MongoDB para persistência. Suporta 10.000 usuários simultâneos com latência p95 <100ms.
...
5. [Configuração e Execução](#️-configuração-e-execução)
6. [Roadmap](#-roadmap)
...
Sistema de mensageria **completo e escalável** que permite:
